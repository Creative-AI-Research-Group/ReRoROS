...
class IK_move:
    ...
    def __init__(self, base, shoulder, elbow, wrist, gripper, all_motors):
    ...
    # cals degrees for IK for each joinnt
    ...
    def executeMove(self, move, params, color, homography, cap, selectedCam):
